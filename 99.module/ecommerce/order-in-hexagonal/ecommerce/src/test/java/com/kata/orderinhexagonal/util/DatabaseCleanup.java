...
/**
 * TODO - c-b-9-1. 테스트 격리를 위한 DB 초기화
...
public class DatabaseCleanup implements InitializingBean {
  ...
  private void resetH2() {
    ...
    for (final String tableName : tableNames) {
      entityManager.createNativeQuery("TRUNCATE TABLE " + tableName + " RESTART IDENTITY").executeUpdate(); //테이블 비우고 id auto_increment 된 것을 다시 1로 초기화해주는 것
    }

package _1_syntax._1_by_jdk_versions.jdk8.lambda.step4_method_reference;

import java.util.Arrays;
import java.util.List;
import _1_syntax._1_by_jdk_versions.jdk8.stream.MaleStudent;
import _1_syntax._1_by_jdk_versions.jdk8.stream.Student;
/*
---
Q. :: ?
...
public class Main {
  public static void main(String[] args) {
		...
		System.out.println("-----------------------------");
		maleStudentListMethodReference.getList().forEach(s -> System.out.println(s.getName()));
		System.out.println("-----------------------------");
		maleStudentListMethodReference.getList().forEach(System.out::println); //tip: Student.java에 toString() 오버라이드 안하면 객체 주소 뜸. jdk.jdk8.stream.Student@1fb3ebeb. 근데 오버라이드 하면 바뀜. Student(name: 홍길동, score: 10)
		System.out.println("================================");

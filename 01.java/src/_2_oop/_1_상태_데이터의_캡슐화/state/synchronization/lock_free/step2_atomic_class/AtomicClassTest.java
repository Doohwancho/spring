package _2_oop._1_상태_데이터의_캡슐화.state.synchronization.lock_free.step2_atomic_class;
...
public class AtomicClassTest {
	...
	public class AtomicInteger extends Number implements java.io.Serializable {
	    ...
	    public final boolean compareAndSet(int expect, int update) {
	        return performance.unsafe.compareAndSwapInt(this, valueOffset, expect, update); //RAM에 process 공유자원의 값과 local thread cache에 expect과 비교해서 같으면 update 값을 넣어주는 함수
	    }	
	}

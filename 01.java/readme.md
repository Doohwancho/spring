...
b. java _5_socket programming :white_check_mark:\
c. jdk verion별 문법 :white_check_mark:\
d. _2_oop :white_check_mark:\
e. generics :white_check_mark:\
f. access modifier :white_check_mark:\
g. SOLID :white_check_mark:\
h. _3_mvc :white_check_mark:\
i. clean code\
j. _10_functional programming :question:\
k. how jvm works\
...
a-1. _4_io overall structure :white_check_mark:\
...
a-6. _4_io between threads :white_check_mark:\
a-7. serialization :white_check_mark:


b-1. what is web _5_socket? :white_check_mark:\
b-2. java _5_socket programming code :white_check_mark:\
...
c-ㄱ-다-3. lambda - _10_functional interface :white_check_mark:\
...
d-ㄱ. pop\
d-ㄱ-가. calculator from pop to _2_oop :white_check_mark:\
d-ㄱ-나. pop -> _2_oop 도형 예제 :white_check_mark:\
d-ㄴ. state\
...
h-1. build _3_mvc from scratch :white_check_mark:\
h-2. build event listener from scratch using observer pattern :white_check_mark:\
h-3. build calculator in _3_mvc + observer pattern :white_check_mark:\
h-4. build search in _3_mvc pattern using event listener :white_check_mark:
...
l-ㅂ-가-2. wrong advice: _2_oop style :white_check_mark:
...
a-1. [_4_io overall structure](https://www.youtube.com/watch?v=FqqzbRPSAks&list=PLz4XWo74AOafFAkhYJK3SDBIrXjsaIu66&index=15) \
...
a-6. _4_io between threads - 자바의 정석 \
a-7. serialization - 자바의 정석


b-1. [what is web _5_socket?](https://www.youtube.com/watch?v=yXPCg5eupGM) \
b-2. [자바 소켓 통신(Socket)을 사용하는 이유와 동작 원리 및 코드](https://wildeveloperetrain.tistory.com/122) \
b-3. [TCP _5_socket programming - chatting](https://lktprogrammer.tistory.com/64?category=672211)
...
d-가. [calculator from pop to _2_oop](https://github.com/serverwizard/oop-practice) \
...
h-1,2. build _3_mvc from scratch - udemy "java design pattern and architecture" by John Purcell\
...
h-4. [build search in _3_mvc + observer pattern](https://link-intersystems.com/blog/2013/07/20/the-mvc-pattern-implemented-with-java-swing/)
...
j-14..17. [_10_functional interface most frequently used](https://yhmane.tistory.com/203) \

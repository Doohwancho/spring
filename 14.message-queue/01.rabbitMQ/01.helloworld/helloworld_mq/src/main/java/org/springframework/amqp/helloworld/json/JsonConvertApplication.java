package org.springframework.amqp.helloworld.json;
...
/*
    Q. what is this code?
    Message를 json format으로 보내는 코드
    spring app끼리 rabbitmq's message를 통해 통신하는게 아닐 경우 사용.
    아니면 spring app에서 message 받을 때, message format이 다른 타입일 경우 type conversion 용으로 사용
    
 */

@SpringBootApplication
public class JsonConvertApplication {
    ...
    public static void main(String[] args) throws Exception {
        ConfigurableApplicationContext ctx = SpringApplication.run(JsonConvertApplication.class, args);
        ctx.getBean(JsonConvertApplication.class).runDemo(ctx.getBean("rabbitTemplate", RabbitTemplate.class),
    ...
    public SimpleMessageListenerContainer legacyPojoListener(ConnectionFactory connectionFactory) {
        ...
        MessageListenerAdapter messageListener = new MessageListenerAdapter(new Object() {
            ...
            public void handleMessage(Object object) {
                ...
                JsonConvertApplication.this.latch.countDown();
            }

package org.springframework.amqp.helloworld.stream;
...
/*
    Q. what is this code?
    100개의 message를 queue가 아닌, stream에 보내는 코드
    stream is built for high throughput, low latency messaging (compared to queue)
 */
...
public class SpringRabbitStreamsApplication implements BeanFactoryAware {
    ...
    //message 100개 만들어서 stream에 보내는 코드
    @Bean

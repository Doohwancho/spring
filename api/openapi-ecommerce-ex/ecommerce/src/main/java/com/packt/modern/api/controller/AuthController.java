...
import com.packt.modern.api.exception.custom.InvalidRefreshTokenException;
...
public class AuthController {
    ...
    public ResponseEntity<SignedInUser> getAccessToken(@Valid RefreshToken refreshToken) {
        return ok(
            service.getAccessToken(refreshToken).orElseThrow(InvalidRefreshTokenException::new));
    }

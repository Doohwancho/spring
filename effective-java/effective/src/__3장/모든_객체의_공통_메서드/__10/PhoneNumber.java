...
public class PhoneNumber {
    /**
        만약 equals() 재정의 안하면, 그 객체는 오직 자기 자신과만 같다고 판단한다.
        두 인스턴스의 '물리적 동치성' 만 체크해야 하는게 아니라, '논리적 통치성'을 검사할 일이 있는 경우, equals()를 재정의 해주어야 한다.
        ex. 두 객체를 .equals()로 비교할 때, 같은 객체인지 알고싶은게 아니라, 그 안에 들어있는 값이 같은지 확인하고 싶은 경우

        만약 객체 안 필드의 타입이 또 다른 객체라면, 그 객체의 equals()를 재귀적으로 호출하거나, 그 객체의 값을 불러와 비교해야 한다.
     */

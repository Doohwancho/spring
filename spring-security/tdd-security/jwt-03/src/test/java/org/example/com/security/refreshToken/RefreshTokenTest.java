package org.example.com.security.refreshToken;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.core.type.TypeReference;
import org.example.com.bbs.domain.SpBoard;
import org.example.com.bbs.domain.SpBoardSummary;
import org.example.com.bbs.service.SpBoardService;
import org.example.com.bbs.service.SpBoardTestHelper;
import org.example.com.security.config.SpJwtRefreshableTwoUserIntegrationTest;
...
public class RefreshTokenTest extends SpJwtRefreshableTwoUserIntegrationTest {
    ...
    void test_1() throws URISyntaxException, JsonProcessingException, InterruptedException {
        ...
        게시판의_게시글이_2개인걸_확인한다(첫번째토큰); //org.springframework.web.client.HttpClientErrorException$Forbidden: 403 : [{"timestamp":"2023-03-26T11:52:26.402+00:00","status":403,"error":"Forbidden","message":"","path":"/board/list"}]

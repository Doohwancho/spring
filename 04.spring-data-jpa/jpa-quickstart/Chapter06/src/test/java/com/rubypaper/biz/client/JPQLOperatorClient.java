...
public class JPQLOperatorClient {
	...
	private static void dataSelect(EntityManagerFactory emf) {
		...
		//Employee : Department = N : 1 에서, 직원이 속해 있는 상태의 Department 목록을 검색한다.
		//TODO - h-7. 묵시적 join in jpql
		//Employee table을 join 안했는데, of d.employeeList 를 통해 employee table에 접근할 수 있다.

package oop.generics.wildcard;

import java.util.ArrayList;
import java.util.List;

import oop.generics.extendsAndSuper.Apple;
import oop.generics.extendsAndSuper.Banana;
import oop.generics.extendsAndSuper.Fruit;
